...
export default function PageShell({ eyebrow, title, highlight, intro, children }: Props) {
  ...
  return (
    <div className="pb-8 pt-32 sm:pt-36">
      {/* ------------------------------ page header ----------------------------- */}
      <header ref={headRef} className="relative">
        <div className="dot-grid absolute inset-0 -z-10" aria-hidden />
        <div className="mx-auto max-w-6xl px-5 sm:px-6">
          {/* breadcrumb */}
          <div data-ph="crumb" className="flex items-center gap-2 font-mono text-[11px] font-semibold uppercase tracking-[0.18em] text-gray-400">
          ...
          <div className="mt-6 flex flex-col gap-6 sm:flex-row sm:items-start sm:gap-8">
            ...
            <div className="min-w-0">
              <span className="glass-soft inline-flex items-center gap-2 rounded-full px-3.5 py-1.5 font-mono text-[10.5px] font-semibold uppercase tracking-[0.18em] text-inksoft">
      ...
      {/* --------------------------------- pager -------------------------------- */}
      <nav className="mx-auto mt-16 max-w-6xl px-5 sm:mt-20 sm:px-6">
