...
export default function Footer() {
  ...
  return (
    <footer className="relative px-5 pb-8 pt-8 sm:px-6 sm:pb-10 sm:pt-10">
      <div className="mx-auto max-w-6xl">
        <div className="glass overflow-hidden rounded-[2rem]">
          <div className="grid gap-8 p-6 sm:p-10 lg:grid-cols-[1.4fr_1fr_1fr]">
            {/* brand block */}
            <div>
          ...
          {/* bottom bar */}
          <div className="flex flex-col items-center justify-between gap-4 border-t border-gray-200/70 bg-white/40 px-6 py-5 sm:flex-row sm:px-10">
