  ...
  return (
    <>
      <header className="fixed inset-x-0 top-4 z-50 flex justify-center px-4">
        <nav
          className={`glass-deep flex w-full max-w-5xl items-center justify-between gap-2 rounded-full py-2 pl-3 pr-2 transition-shadow duration-500 sm:pl-4 ${
      ...
      >
        ...
        <div
          className={`absolute inset-x-4 top-4 rounded-[2rem] p-6 transition-all duration-500 ${
