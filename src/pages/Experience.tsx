  ...
  return (
    ...
    >
      <div ref={wrap} className="relative mt-14">
        {/* spine */}
        <div className="absolute left-[1.15rem] top-0 h-full w-px bg-gray-200/80 sm:left-[1.4rem]" />
        <div
          ref={line}
          className="absolute left-[1.15rem] top-0 h-full w-[3px] origin-top -translate-x-[1px] rounded-full bg-gradient-to-b from-gblue via-gyellow to-ggreen sm:left-[1.4rem]"
