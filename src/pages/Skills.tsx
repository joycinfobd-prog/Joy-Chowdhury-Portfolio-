    ...
    >
      ...
      <Reveal className="mt-14 grid gap-5 sm:grid-cols-2" stagger={0.13} y={60}>
        {skillCategories.map((cat) => {
          ...
          return (
            <article key={cat.title} className={`glass lift group relative overflow-hidden rounded-[1.8rem] p-6 sm:p-7 ${a.glow}`}>
      ...
      <Reveal className="mt-6 grid gap-5 lg:grid-cols-2" stagger={0.14} y={56}>
        ...
        <div className="glass relative overflow-hidden rounded-[1.8rem] p-7">
