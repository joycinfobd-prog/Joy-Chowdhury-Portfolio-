  ...
  return (
    ...
    >
      ...
      <div className="mt-14 grid gap-6 lg:grid-cols-[1.35fr_1fr]">
        <Reveal className="glass relative overflow-hidden rounded-[2rem] p-6 sm:p-10" y={56}>
          ...
          <div className="relative">
            ...
            <div className="mt-10 flex items-center justify-between border-t border-gray-200/70 pt-6">
              ...
              <span className="font-display text-5xl font-extrabold text-google opacity-90">{profile.initials}</span>
            </div>
          </div>
        </Reveal>
        ...
        <Reveal className="flex flex-col gap-5" stagger={0.14} y={56}>
          ...
          <Link
            to="/contact"
            className="glass lift group flex items-center justify-between gap-4 rounded-[1.8rem] p-6 hover:border-gblue/40 sm:p-7"
          >
            <span>
