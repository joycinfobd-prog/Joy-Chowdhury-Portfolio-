          ...
          return (
            ...
            >
              ...
              <div className="relative flex flex-wrap items-start justify-between gap-3 sm:gap-4">
                <span className={`grid h-14 w-14 shrink-0 place-items-center rounded-3xl ${a.iconWell} transition-transform duration-500 group-hover:scale-110 group-hover:-rotate-6 sm:h-16 sm:w-16`}>
                  <cert.icon className="h-7 w-7 sm:h-8 sm:w-8" />
                </span>
                <span className={`inline-flex max-w-full items-center gap-1.5 rounded-full px-3 py-1.5 text-center text-[10px] font-bold uppercase leading-snug tracking-[0.1em] sm:text-[10.5px] sm:tracking-[0.12em] ${a.chip}`}>
