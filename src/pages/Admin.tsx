          ...
          {tab === "Photo" && (
            <div className="flex flex-col gap-4">
              <p className="text-[13px] text-inksoft">
                Upload a portrait for the home page frame. Square or 4:5 portrait works best — keep it under ~500 KB.
                Tip: you can also just replace <span className="font-mono font-bold">joy-portrait.jpg</span> next to
                the deployed <span className="font-mono font-bold">index.html</span> (or in{" "}
                <span className="font-mono font-bold">public/</span> before deploying) — the site picks it up
                automatically, no upload needed here.
              </p>
